...
def setup_product():
    ...
    import sidecar.endpoint
    zcml.load_config('configure.zcml', sidecar.endpoint)
    ...
    ztc.installPackage('sidecar.endpoint')
...
setup_product()
ptc.setupPloneSite(products=['sidecar.endpoint'])
